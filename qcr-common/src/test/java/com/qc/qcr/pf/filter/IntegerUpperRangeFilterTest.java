...
public class IntegerUpperRangeFilterTest extends AbstractDataFilterTest<SensorData<Integer>, SensorData<Integer>> {

	public IntegerUpperRangeFilterTest() {
		super(new RangeFilter(80, -1));
		...
		setExpectedOutput(Arrays.asList(hr5,hr6,hr7));
		}
}
